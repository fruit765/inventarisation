...
INSERT INTO `brand` VALUES (1,'samsung'),(2,'sony');
...
INSERT INTO `category` VALUES (1,'Комплектующие',NULL,NULL),(2,'Что-топромежуточное',NULL,1),(3,'Память','{\"type\": \"object\", \"properties\": {\"amount\": {\"type\": \"integer\"}, \"latency\": {\"type\": \"string\"}}}',2);
...
INSERT INTO `credentials` VALUES (1,'admin@admin.admin','$2b$12$rllig/0mJQ55zywbQdIPF.NwB4m.Y0j07FVolXIjO.McX9z30WW7K',1);
...
INSERT INTO `dep_loc` VALUES (1,1,2),(2,2,2);
...
INSERT INTO `department` VALUES (1,'web-разработки'),(2,'Дизайна');
...
CREATE TABLE `device` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `device_UN` (`inv_number`),
...
INSERT INTO `device` VALUES (2,NULL,3,1,1,1,2,1,'FGRD-45','Хороший девайс',999,0,'{\"amount\": 4096, \"latency\": \"15-15-15-15\"}','2011-11-11','2021-12-12','Память-453'),(3,NULL,3,2,2,2,1,2,'DSFSD-444','',234234,0,'{\"amount\": 1024, \"latency\": \"16-26-26-13\"}','2012-11-11','2022-10-10','Память-111'),(4,NULL,3,1,1,1,2,1,'FGRD-45','Хороший девайс',999,0,'{\"amount\": 4096, \"latency\": \"15-15-15-15\"}','2011-11-11','2021-12-12','Память-457'),(5,NULL,3,2,2,2,1,2,'DSFSD-444','',234234,0,'{\"amount\": 1024, \"latency\": \"16-26-26-13\"}','2012-11-11','2022-10-10','Память-115'),(6,NULL,3,1,1,1,2,1,'FGRD-45','Хороший девайс',999,0,'{\"amount\": 4096, \"latency\": \"15-15-15-15\"}','2011-11-11','2021-12-12','Память-4588'),(7,NULL,3,1,1,1,2,1,'FGRD-45','Хороший девайс',999,0,'{\"amount\": 4096, \"latency\": \"15-15-15-15\"}','2011-11-11','2021-12-12','Память-4536'),(8,NULL,3,2,2,2,1,2,'DSFSD-444','',234234,0,'{\"amount\": 1024, \"latency\": \"16-26-26-13\"}','2012-11-11','2022-10-10','Память-1112'),(9,NULL,3,2,2,2,1,2,'DSFSD-444','',234234,0,'{\"amount\": 1024, \"latency\": \"16-26-26-13\"}','2012-11-11','2022-10-10','Память-1113'),(10,NULL,3,2,2,2,1,2,'DSFSD-444','',234234,0,'{\"amount\": 1024, \"latency\": \"16-26-26-13\"}','2012-11-11','2022-10-10','Память-1114'),(11,NULL,3,2,2,2,1,2,'DSFSD-444','',234234,0,'{\"amount\": 1024, \"latency\": \"16-26-26-13\"}','2012-11-11','2022-10-10','Память-1115');
...
INSERT INTO `employer` VALUES (1,'Иванов В. В.'),(2,'Петров С. С.');
...
INSERT INTO `location` VALUES (1,'Склад'),(2,'Офис');
...
INSERT INTO `post` VALUES (1,'веб-программист'),(2,'дизайнер');
...
INSERT INTO `post_dep_loc` VALUES (1,1,1),(2,2,2);
...
INSERT INTO `sessions` VALUES ('21UN0BBFXppw81ddxS2tFg9SpRWHlYtD','{\"cookie\": {\"path\": \"/\", \"expires\": \"2020-11-27T21:14:44.850Z\", \"httpOnly\": true, \"originalMaxAge\": 900000000}, \"passport\": {}}','2020-11-27 21:17:54');
...
INSERT INTO `status` VALUES (3,'archive'),(2,'given'),(1,'stock'),(4,'warranty');
...
INSERT INTO `supplier` VALUES (1,'ДНС'),(2,'Ситилинк');
...
INSERT INTO `user` VALUES (1,1,1,2,'Иванов Иван Иванович',0,'2011-11-20','{\"email\": \"sobaka@sobaka.ru\", \"phone\": \"+79999999\"}'),(2,2,2,2,'Сидоров Иван Николаевич',0,'2019-11-20','{\"email\": \"cat@cat.ru\", \"phone\": \"+788888888\"}');
...
-- Dump completed on 2020-11-17 18:00:52
