...
--
-- Table structure for table `department_has_location`
--

DROP TABLE IF EXISTS `department_has_location`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `department_has_location` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_department_has_location_location1` FOREIGN KEY (`location_id`) REFERENCES `location` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `department_has_location`
--

LOCK TABLES `department_has_location` WRITE;
/*!40000 ALTER TABLE `department_has_location` DISABLE KEYS */;
/*!40000 ALTER TABLE `department_has_location` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `history` (
  ...
  KEY `fk_history_account1_idx` (`account_id`),
  KEY `fk_history_action_code1_idx` (`action_code_id`),
  CONSTRAINT `fk_history_account1` FOREIGN KEY (`account_id`) REFERENCES `account` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE `post` (
  ...
  `department_has_location_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_post_department_has_location1_idx` (`department_has_location_id`),
  CONSTRAINT `fk_post_department_has_location1` FOREIGN KEY (`department_has_location_id`) REFERENCES `department_has_location` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
